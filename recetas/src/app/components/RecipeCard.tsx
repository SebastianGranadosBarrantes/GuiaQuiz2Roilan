...
setSelectedRecipe(recipeUri === selectedRecipe ? null :
recipeUri);
};
11
...
<p
className="recipe-cuisineType">{hit.recipe.cuisineType}</p>
...
{[...Array(Math.ceil(data.hits.length /
itemsPerPage))].map(
(_, index) => (
<button key={index} onClick={() =>
handlePageChange(index + 1)} className={`pagination-button
